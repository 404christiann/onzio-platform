...
| Email deliverability becomes a hard authentication dependency | `PLAT-101` | **Accepted 2026-08-03** with the exact staging package approval | SPF/DKIM in place; DMARC `p=none` pending separate hardening; bounce monitoring not implemented; delivery verified against Yahoo and Gmail, AOL and ISP-hosted waived 2026-08-03 as accepted residual risk. |
