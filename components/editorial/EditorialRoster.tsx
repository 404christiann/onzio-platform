 ...
 * /roster page (app/(public)/roster/page.tsx) already uses -- no duplicate
 * query was added) and passes them down to the presentational
 * EditorialRosterView, mirroring EditorialHome's fetch-once-and-pass-down
 * composition from E3.
 */
