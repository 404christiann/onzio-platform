 ...
 * classic `/schedule` page already calls — rather than duplicating a query)
 * and passes them down to the presentational `EditorialScheduleView`,
 * mirroring `EditorialHome`/`EditorialRoster`'s fetch-once-and-pass-down
 * composition from L4/L5.
 *
