...
import PathwayUpslFixtures from "@/components/pathway/PathwayUpslFixtures";
...
export default function SchedulePage() {
  ...
  if (club.presentationTemplateKey === "pathway@1") return <PathwayUpslFixtures {...upslFixturesContent} />;
